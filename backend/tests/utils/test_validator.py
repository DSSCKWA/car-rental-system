...
class TestValidator(unittest.TestCase):
    def test_is_valid_email(self):
        ...
        self.assertIsNotNone(is_valid_email('aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa@a.pl'))
    ...
    def test_is_valid_phone_number(self):
        self.assertTrue(is_valid_phone_number('111111111'), 'Phone number is valid')
